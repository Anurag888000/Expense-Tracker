    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 p-6 rounded-3xl relative overflow-hidden group">
          ...
          <p className="text-4xl font-bold text-white relative z-10">₹{balance.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 p-6 rounded-3xl relative overflow-hidden group">
          ...
          <p className="text-4xl font-bold text-emerald-400 relative z-10">₹{totalIncome.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 p-6 rounded-3xl relative overflow-hidden group">
          ...
          <p className="text-4xl font-bold text-red-400 relative z-10">₹{totalExpense.toFixed(2)}</p>
        </div>
      </div>

      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-8">
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 p-6 rounded-3xl h-[450px] relative overflow-hidden flex flex-col">
